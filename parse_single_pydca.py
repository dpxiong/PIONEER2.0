...
raw_plmdca_dir = '../data/single_raw_plmdca/'
raw_mfdca_dir = '../data/single_raw_mfdca/'
plmdca_dir = '../data/single_plmdca/'
mfdca_dir = '../data/single_mfdca/'
...
for identifier in sorted(list(fasta_dict.keys())):
    ...
    with open(mfdca_dir+identifier+'.pkl', 'wb') as outfile:
